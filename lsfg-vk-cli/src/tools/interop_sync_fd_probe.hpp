...
namespace lsfgvk::cli::interop_sync_fd_probe {
    ...
    struct ExportedFd { int fd{-1}; bool valid{}; [[nodiscard]] bool sentinel() const noexcept { return valid && fd == -1; } };
    ...
    [[nodiscard]] bool temporaryImport() noexcept;
    [[nodiscard]] bool acceptsSyncFd(const ExportedFd&) noexcept;
